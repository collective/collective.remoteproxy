...
class TestSetup(unittest.TestCase):
    ...
    def test_product_installed(self):
        ...
        self.assertTrue(self.installer.is_product_installed("collective.remoteproxy"))
...
class TestUninstall(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.installer.uninstall_product("collective.remoteproxy")
        setRoles(self.portal, TEST_USER_ID, roles_before)

    def test_product_uninstalled(self):
        """Test if collective.remoteproxy is cleanly uninstalled."""
        self.assertFalse(self.installer.is_product_installed("collective.remoteproxy"))
