...
COLLECTIVE_REMOTEPROXY = IntegrationTesting(
    bases=(COLLECTIVE_REMOTEPROXY,), name="BrowserLayer:IntegrationTesting"
)


COLLECTIVE_REMOTEPROXY = FunctionalTesting(
    bases=(COLLECTIVE_REMOTEPROXY,), name="BrowserLayer:FunctionalTesting"
)


COLLECTIVE_REMOTEPROXY = FunctionalTesting(
    bases=(COLLECTIVE_REMOTEPROXY, REMOTE_LIBRARY_BUNDLE_FIXTURE, z2.ZSERVER_FIXTURE),
